 ...
 */
class Engitech_Testimonials4 extends Widget_Base{
	...
	public function get_title() {
		return __( 'Engitech Testimonial Slider 4', 'engitech' );
	}
...
// After the Engitech_Testimonials4 class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register_widget_type( new Engitech_Testimonials4() );